...
export default function ComplaintStartPage(){
  ...
  return <div className="app customerPage portalComplaintPage"><PortalHeader/><main className="customerMain">
    ...
    <section className="customerHero compactHero"><span className="customerEyebrow">SERVICE SUPPORT</span><h1>Register Complaint</h1><p>Enter your registration number to report a problem with your product.</p></section>
