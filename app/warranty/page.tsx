...
export default function WarrantyLookupPage() {
  ...
  return <div className="app customerPage portalWarrantyPage"><PortalHeader/><main className="customerMain">
    ...
    <section className="customerHero compactHero"><span className="customerEyebrow">WARRANTY</span><h1>Warranty Status</h1><p>Enter your registration number to check warranty details.</p></section>
