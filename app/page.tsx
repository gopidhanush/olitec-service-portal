    ...
    <div className="app customerPage customerHome">
      ...
      <main className="customerMain">
        ...
        <section className="customerSection customerRegistrationCard">
          ...
          <button className="customerTextButton" type="button" onClick={() => router.push('/register')}>
        ...
        <div className="customerGrid">
          <button className="customerSection customerActionCard" type="button" onClick={() => router.push('/warranty')}>
            <span className="customerBadge">Warranty</span>
            <h2>Warranty Status</h2>
            <p>Check whether your OLITEC warranty is active.</p>
            <span className="customerButton customerButtonSecondary">Check Warranty <span>→</span></span>
          </button>

          <button className="customerSection customerActionCard" type="button" onClick={() => router.push('/service/complaint')}>
            <span className="customerBadge">Service</span>
            <h2>Register Complaint</h2>
            <p>Report a problem with your registered OLITEC product.</p>
            <span className="customerButton customerButtonSecondary">Register Complaint <span>→</span></span>
          </button>

          <button className="customerSection customerActionCard customerActionWide" type="button" onClick={() => router.push('/service/track')}>
            <span className="customerBadge">Service Support</span>
            <h2>Complaint Status</h2>
            <p>Track the latest status of an existing service complaint.</p>
            <span className="customerButton customerButtonPrimary">Track Complaint <span>→</span></span>
          </button>
        </div>
      </main>
